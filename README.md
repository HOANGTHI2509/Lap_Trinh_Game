...
Dự án được định hướng mở rộng thành một tựa game sinh tồn RPG mang yếu tố Roguelite kết hợp với kiến trúc lưu trữ dữ liệu chuyên nghiệp. Lộ trình phát triển được chia làm 4 giai đoạn trọng điểm:

### Giai đoạn 1: Hoàn thiện Trải nghiệm Nghe - Nhìn (Polishing)
* **Audio & VFX System:** Tích hợp hệ thống quản lý âm thanh động (Dynamic Audio Manager). Bổ sung nhạc nền (BGM) thay đổi theo nhịp độ trận đấu, hiệu ứng âm thanh (SFX) đa dạng cho tiếng kiếm chém, tiếng gầm của quái và tiếng bước chân.
* **Particle System:** Thiết lập Particle2D cho hiệu ứng máu văng, bụi ma thuật, và hiệu ứng ánh sáng rực rỡ (Glow/Bloom) mỗi khi Dũng sĩ thăng cấp.
* **Floating Damage UI:** Xây dựng hệ thống UI độc lập sinh ra các con số sát thương động (bay lên và mờ dần) mỗi khi có đòn đánh trúng đích để tăng cường "Game Feel".

### Giai đoạn 2: Đa dạng hóa Gameplay (Mechanics & Combat)
* **Kỹ Năng Chủ Động (Active Skills):** Bổ sung thanh Năng lượng (Mana/Stamina). Thiết kế kỹ năng Lướt (Dash) cung cấp i-frame (vô địch trong tích tắc) để né đòn, và chiêu thức "Chém Lốc Xoáy" (Tornado Slash) gây sát thương diện rộng (AOE).
* **Đa Dạng Hóa Quái Vật (Enemy Archetypes):** Mở rộng hệ thống AI để sinh ra nhiều chủng loại: Xương Đao Phủ (Máu trâu, cận chiến), Xương Cung Thủ (Cấu rỉa tầm xa), và Phù Thủy Xương (Gọi đệ, đặt bẫy độc).
* **Cơ chế Đánh Boss (Boss Fight):** Thiết kế máy trạng thái hữu hạn (FSM) phức tạp cho Boss Khổng Lồ (xuất hiện ở cấp 10). Boss sẽ có nhiều Phase đánh khác nhau, ép người chơi phải sử dụng chiến thuật hit-and-run thay vì đứng tank sát thương.

### Giai đoạn 3: Hệ Thống Vật Phẩm và Kinh Tế (Inventory & Economy)
* **Loot Drop & RNG:** Xây dựng thuật toán rơi rớt vật phẩm dựa trên tỷ lệ ngẫu nhiên. Quái chết có thể rơi ra Bình Hồi Máu (Health Potion), Bình Năng Lượng, hoặc Vàng.
* **Hệ Thống Cửa Hàng (Shop System):** Thêm NPC Thương nhân vào một góc an toàn của bản đồ. Người chơi dùng Vàng thu thập được để mua vật phẩm hỗ trợ hoặc Nâng cấp chỉ số cơ bản của kiếm (Base Damage).

### Giai đoạn 4: Kiến Trúc Lưu Trữ và Cơ Sở Dữ Liệu (Database & Cloud)
* **Hệ thống Lưu Trữ Cục Bộ (Local Save/Load):** Mã hóa tiến trình chơi (Cấp độ, EXP, Vàng, Trang bị, Tọa độ hiện tại) thành định dạng JSON/Binary và lưu xuống ổ cứng cục bộ thông qua API `FileAccess` của Godot.
* **Tích Hợp Database Backend (Cloud Storage):** 
  * Phát triển một cụm RESTful API Backend độc lập (sử dụng ASP.NET Core) làm cầu nối kết nối Game với Cơ Sở Dữ Liệu (SQL Server hoặc PostgreSQL).
  * **Bảng Xếp Hạng Toàn Cầu (Global Leaderboard):** Xây dựng bảng xếp hạng thời gian thực, vinh danh những Dũng sĩ đạt cấp độ cao nhất hoặc giết được nhiều quái nhất.
  * **Đăng Nhập & Cloud Save:** Cho phép người chơi tạo tài khoản, đồng bộ hóa dữ liệu nhân vật lên máy chủ đám mây. Người chơi có thể đăng nhập trên máy tính khác và tiếp tục cuộc hành trình ngay tại nơi họ vừa dừng lại.
